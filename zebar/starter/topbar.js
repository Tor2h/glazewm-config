...
const providers = zebar.createProviderGroup({
  ...
  cpu: { type: "cpu" },
  date: { type: "date", formatting: "EEE d/MM" },
...
function App() {
  ...
  function getMediaButton(mediaOutput) {
    if (mediaOutput?.session === null) {
      return;
    }
    if (mediaOutput?.session?.isPlaying) {
  ...
  return (
    <div className="app">
          ...
          <div className="left">
            <div className="media-container">
              <div className="artist">
                <i className="nf nf-md-account_music"></i>{output.media?.session?.artist}
              </div>
              <div className="title">
                <i className="nf nf-fa-music"></i>{output.media?.session?.title}
              </div>
            </div>
          </div>
        )}
      ...
      <div className="right">
        <span className="time">
          <i className="nf nf-oct-clock"></i>{output.time?.formatted}
        </span>
        <span className="date">
          <i className="nf nf-oct-calendar"></i>{output.date?.formatted}
        </span>
